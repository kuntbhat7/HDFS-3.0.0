...
#Testing Datanode
inspec exec common-test-script.rb -t docker://datanode
...
inspec exec common-test-script.rb -t docker://resourcemanager
...
#Testing Hive
inspec exec common-test-script.rb -t docker://hive
